$(document).ready(function(){
  ...
  if (window.location.href.indexOf("do-you-need-support") != -1) {
    console.log("tb-v2");
  ...
  if (window.location.href.indexOf("example-no-jshttps://www.reminders.mot-testing.service.gov.uk/cookies") != -1) {
    //console.log("tb-v2");
    //$('.govuk-header__link.govuk-header__link--service-name').attr('href','/tb-v2/index-2').text('Trainer bookers');
  ...
  */
  ...
  $('.find-dl-number').click(function(){
    ...
    if ($('#find-dl-number').val().length < 16) {
      ...
      $('.wrap-find').parent().find('.hidethis').append('<p class="error-message-text">You must entre a valid driver licence number (DHILL787FTT8RT89)</p>');
